      ...
      <Container>
        <Row className="all-container">
          <Col md={6} className="new-product__form--container">
            <h1 className="mt-4-1">Edit product</h1>

            <Form className="form-all" onSubmit={handleSubmit}>
              {isSuccess && (
                <Alert variant="success">Product updated successful</Alert>
              )}
              ...
              <div className="form-group-item">
                ...
                <div className="category-price">
                  <Form.Group className="mb-cat">
                    <Form.Label className="lable-text">Quaility</Form.Label>
                    <Form.Control
                      type="number"
                ...
                >
                  ...
                  <Form.Select value={category} className="lable-text">
